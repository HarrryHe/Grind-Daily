    ...
    return (
        <div className="home flex flex-col justify-center items-center">
            ...
            <div className="grid grid-cols-1 gap-6 mt-12 mb-10 text-lg text-gray-400 w-10/12 sm:grid-cols-3">
                <NavLink
                    to="/task"
                    className="relative bg-slate-300 p-8 h-auto w-full text-center text-xl font-semibold text-gray-800 rounded-lg shadow-lg hover:bg-slate-400 hover:scale-105 transition duration-500 flex flex-col justify-between items-center"
                >
                    Daily Challenges
                    <Lottie
                        animationData={hand}
